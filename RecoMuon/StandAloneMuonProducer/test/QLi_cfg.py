...
#      'file:../../MuonSeedGenerator/test/seed-csc.root'
      'file:../../MuonSeedGenerator/test/seed-cscgem.root'
    )
)
...
#                                         MuonCollectionLabel = cms.untracked.InputTag('standAloneMuons'),
#                                         MuonSeedCollectionLabel = cms.untracked.InputTag('MSeed'),
